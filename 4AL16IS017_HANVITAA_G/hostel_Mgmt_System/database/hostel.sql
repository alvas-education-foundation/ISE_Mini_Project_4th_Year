...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2018 at 12:06 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Get_All_course` ()  READS SQL DATA
BEGIN
SELECT * FROM courses;
END$$
...
(111, 'hanvitaa', 'hanvitaa@gmail.com', 'gangu', '2018-11-24 18:30:00', '2018-11-25');
...
(10, 100, 5, 0, 1, '2018-01-25', 1, 'Bachelor of Engineering', 111, 'hanvitaa', '', 'g', 'female', 9686370479, 'hanvitaa@gmail.com', 9686370479, 'hanvitaa', 'father', 7894561325, '123,2nd cross,shanthinagar', 'bangalore', 'Karnataka', 560027, '123,2nd cross,shanthinagar', 'bangalore', 'Karnataka', 560027, '2018-11-25 07:07:36', ''),
(11, 201, 1, 6000, 0, '2018-11-25', 12, 'Bachelor of Engineering', 222, 'nikshita', 'u', 'shetty', 'female', 12345567788, 'nik@gmail.com', 1236587495, 'hanvitaa', 'friend', 658997412358, '456,mijar', 'mangalore', 'Karnataka', 654789, '456,mijar', 'mangalore', 'Karnataka', 654789, '2018-11-25 08:34:48', ''),
(12, 132, 1, 2000, 1, '2018-11-29', 1, 'Bachelor  of Science', 123, 'gowthami', '', 'H', 'female', 4569871235, 'gowthami@gmail.com', 4557895465, 'hanvitaa', 'friend', 7894561325, '456,mijar', 'mangalore', 'Karnataka', 654789, '456,mijar', 'mangalore', 'Karnataka', 654789, '2018-11-29 12:57:47', '');
...
(6, 2, 456, 5000, '2018-11-29 13:00:02');
...
(7, 21, 'hanvitaa@gmail.com', 0x3a3a31, '', '', '2018-11-25 07:02:58'),
(8, 22, 'nik@gmail.com', 0x3a3a31, '', '', '2018-11-25 08:31:34'),
(9, 23, 'gowthami@gmail.com', 0x3a3a31, '', '', '2018-11-29 12:55:54'),
(10, 22, 'nik@gmail.com', 0x3a3a31, '', '', '2018-11-30 07:53:28'),
(11, 21, 'hanvitaa@gmail.com', 0x3a3a31, '', '', '2018-12-04 16:36:30');
...
(21, '111', 'Hanvitaa', '', 'G', 'female', 9686370479, 'hanvitaa@gmail.com', 'gangu', '2018-11-25 07:02:31', '04-12-2018 10:07:27', ''),
(22, '222', 'nikshita', 'u', 'shetty', 'female', 12345567788, 'nik@gmail.com', '123', '2018-11-25 08:31:03', '', ''),
(23, '123', 'gowthami', '', 'H', 'female', 4569871235, 'gowthami@gmail.com', 'goa', '2018-11-29 12:55:29', '29-11-2018 06:26:01', '');

--
-- Triggers `userregistration`
--
DELIMITER $$
CREATE TRIGGER `after_insert_userreg` AFTER INSERT ON `userregistration` FOR EACH ROW BEGIN
INSERT INTO user_backup VALUES(NEW.id,NEW.regNo,NEW.firstName,NEW.middleName,NEW.lastName,NEW.gender,NEW.contactNo,NEW.email,NEW.password,NEW.regDate,NEW.updationDate,NEW.passUdateDate);
END
$$
DELIMITER ;
...
INSERT INTO `user_backup` (`id`, `regNo`, `firstName`, `middleName`, `lastName`, `gender`, `contactNo`, `email`, `password`, `regDate`, `updationDate`, `passUdateDate`) VALUES
(10, '108061211', 'code', 'test', 'projects', 'male', 8467067344, 'test@gmail.com', 'Test@123', '2016-06-22 04:21:33', '23-06-2016 11:04:15', '22-06-2016 05:16:49'),
(19, '102355', 'Harry', 'projects', 'Singh', 'male', 6786786786, 'Harry@gmail.com', '6786786786', '2016-06-26 16:33:36', '', ''),
(20, '586952', 'Benjamin', '', 'projects', 'male', 8596185625, 'Benjamin@gmail.com', '8596185625', '2016-06-26 16:40:07', '', ''),
(21, '111', 'hanvitaa', '', 'g', 'female', 9686370479, 'hanvitaa@gmail.com', 'gangu', '2018-11-25 07:02:31', '25-11-2018 12:33:09', ''),
(22, '222', 'nikshita', 'u', 'shetty', 'female', 12345567788, 'nik@gmail.com', '123', '2018-11-25 08:31:03', '', ''),
(23, '123', 'gowthami', '', 'H', 'female', 4569871235, 'gowthami@gmail.com', 'goa', '2018-11-29 12:55:29', '29-11-2018 06:26:01', '');
